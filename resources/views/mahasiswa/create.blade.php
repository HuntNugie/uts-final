            ...
            <div class="row g-3">
                <div class="col-12">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="nm_mahasiswa" value="{{ old("nm_mahasiswa") }}" name="nm_mahasiswa" placeholder="Nama Mahasiswa" required>
                        <label for="nm_mahasiswa">Nama Mahasiswa</label>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-floating">
                        <input type="text" class="form-control" value="{{ old("nim") }}" maxlength="4" pattern="\d{4}" id="nim" name="nim" placeholder="Masukkan 4 digit terakhir nim" required>
                ...
                <div class="col-12">
                    <div class="form-floating">
                        ...
                        aria-label="Floating label select example">
                            ...
                            <option value="{{ $pro->id }}" {{ old("prodi") === $pro->id ? 'selected' : ""   }}>{{ $pro->nm_prodi }} {{ $pro->kd_prodi }}</option>
                            @endforeach
                        </select>
